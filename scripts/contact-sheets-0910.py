"""Renders contact sheets of the batch-0910 photographs for identification by eye.
...
the collar, sleeve length and sponsor wordmark are the first things to go.
    ...
    python scripts/contact-sheets-0906.py --keys p1-p16
    python scripts/contact-sheets-0906.py --keys p1-p16 --grid 4x4 --tile 360
    python scripts/contact-sheets-0906.py --range p118-p147 --name arsenal
    python scripts/contact-sheets-0906.py --boundaries 118,148,190

Writes into .dupcheck/0906/ (gitignored).
"""
import argparse
import json
import os
