/**
 * Renames a team's batch-0906 photographs to their product names and splits the
 ...
 *
 *   stadium supply media/2026-09-06 named/<Team>/<Title> - NN.jpg
 *       what the owner browses. The original zip is never touched.
 *   stadium supply media/2026-09-06 named/_found on web/<Team>/
 *       garments already on stadiumsupply.co.za, filed rather than imported.
 *   import/batch-0906/<team-slug>/<Title> - NN.jpg
 ...
 *
 *   node scripts/apply-0906-names.mjs --team "Real Madrid"
 *   node scripts/apply-0906-names.mjs --team "Real Madrid" --apply
 *   node scripts/apply-0906-names.mjs --all --apply
 */
...
const NAMED = 'C:/Users/MR GLOBAL/Desktop/GioGlobal/stadium supply media/2026-09-06 named';
const MIRROR = 'import/batch-0906';
...
function runTeam(entry) {
  ...
  const notes = [`# ${data.team} - batch 2026-09-06`, ''];
