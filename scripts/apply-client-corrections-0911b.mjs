/**
 * The client's WhatsApp corrections of 11 Sep 2026, applied to the catalogue.
 *
 * The manifest is `scripts/client-corrections-0911b.json`; the reasoning and
 * the eye-verification behind every line is in
 * `client-corrections-2026-09-11b.md`. This file is only the mechanism.
 *
 ...
 *
 *   node scripts/apply-client-corrections-0911b.mjs            # dry run
 *   node scripts/apply-client-corrections-0911b.mjs --apply
 */
...
const M = JSON.parse(readFileSync(new URL("./client-corrections-0911b.json", import.meta.url), "utf8"));
...
if (clashes.length) {
  ...
  console.error("Resolve these in client-corrections-0911b.json (usually the other side of the rotation is missing) and re-run.");
  process.exit(1);
}
