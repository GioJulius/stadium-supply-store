/**
 * Joins the WhatsApp captions to the 664 staged photographs of batch 0905.
 *
 ...
 *
 * Writes scripts/batch-0905/alignment.json and prints a drift report: for every
