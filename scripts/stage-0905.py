"""Stages the 5 Sep 2026 11.59 PM WhatsApp export for import.
...
export's own timestamp order, which is the numbering every batch-0905 document
refers to throughout.

Unlike the earlier batches this one also writes `_files.json`, carrying each
photo's original filename and its parsed wall-clock minute. `align-0905.mjs`
needs that to join the export against the WhatsApp chat, which only ever shows
HH:MM and never the filename.

Run from the repo root:  python scripts/stage-0905.py
"""
import json
import os
import re
...
SRC = 'C:/Users/MR GLOBAL/Desktop/GioGlobal/import/2026-09-05'
DST = 'import/batch-0905-raw'
EXPECTED = 664
